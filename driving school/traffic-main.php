...
<body >
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                           دائرة السير في <small><?php echo $trafficdepartmentname; ?></small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
 ...
 <div class="row text-center">
    <div class="col-md-2 col-md-offset-2">
        <img src="images/16.jpg"  class="img-circle" class="img-responsive" width="250" height="250" alt="">
    </div>
    <div class="col-md-2">
        <img src="images/17.jpg" class="img-circle" class="img-responsive"  width="250" height="250" alt="">
    </div>
    <div class="col-md-2">
         <img src="images/18.jpg" class="img-circle" class="img-responsive" width="250" height="250" alt="">
     </div>
 </div>
 <!-- /.row -->
  <hr>
