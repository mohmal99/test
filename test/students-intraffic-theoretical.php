             ...
             <header class="jumbotron hero-spacer">
              <div class="table-responsive">
                ...
                <tbody>
                    ...
                    <?php $theoreticalsql="select *,concat(FirstName,' ',FatherName,' ',GFatherName,' ',FamilyName)
                                         as name from users,healthdepartment,theoreticaltest,licence where 
                                        users.GovernorateID=healthdepartment.GovernorateId and 
                                        theoreticaltest.UserId=users.UserId and users.LicenceId=licence.LicenceId";
                        $theoreticalresult=mysql_query($theoreticalsql,$connection) or die(mysql_error());
                       while( $theoreticalrow=mysql_fetch_array($theoreticalresult)) {?>
                  <tr>
                       <td> <?php echo $theoreticalrow['name']; ?></td>
                       <td><?php echo $theoreticalrow['Type']; ?></td>
                       <td><?php echo $theoreticalrow['ToryaDate']; ?></td>
